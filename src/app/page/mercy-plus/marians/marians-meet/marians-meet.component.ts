...
@Component({
    selector: "MariansMeet",
    templateUrl: "./marians-meet.component.html"
})
export class MariansMeetComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.items = this.data.getTextItems("marians_meet");
